This is a yet new manner to interact with the Nervousnet Project (http://www.nervousnet.ethz.ch/). With this code, you are able to use Arduino+Wifi+Sensor to save one sensor Data to the backbone of Nervousnet (in this case, it's an Accelerometer sensor).
